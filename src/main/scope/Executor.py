...
class Executor:
    def __init__(self, busses: List[Bus]):
        ...
        self.bus_locations: Dict[Bus, Stop] = {x: x.depot for x in busses}           # locations of bus (or next location bus is arriving at)
    ...
    def check_plan(self, done_r_stops: List[RouteStop]):
