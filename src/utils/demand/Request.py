...
class Request(AbstractRequest):
    ...
    def __init__(self, request_id: int, pick_up_location: Stop, drop_off_location: Stop, earl_start_time: time, latest_arr_time: time, register_time: time, numb_transfer: int):
